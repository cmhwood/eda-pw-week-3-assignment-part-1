...
let favoriteFoods = ["steak", "pizza", "chicken"];
...
let dessert = "cake";
console.log("My dessert is", dessert);
...
let entree = "chicken fried steak";
console.log("My entree is", entree);
...
console.log("Gems are", gemString);
...
console.log("Gems and colors are:", colorfulGems);
